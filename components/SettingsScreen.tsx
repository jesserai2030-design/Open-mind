            ...
            <div className="pt-4 border-t border-[--border-color] space-y-1">
                 ...
                 {activeSetting === 'history' && (
                     <div className="p-2 space-y-2">
                         <div className="flex items-center justify-between p-3 bg-black/20 rounded-lg border border-[--border-color] mb-2">
                            <div>
                                <h4 className="font-medium text-gray-200">{t('privateChatToggle')}</h4>
                                <p className="text-xs text-gray-400">{t('privateChatDesc')}</p>
                            </div>
                            <ToggleSwitch checked={settings.privateChat} onChange={(checked) => handleSettingChange('privateChat', checked)} />
                         </div>
